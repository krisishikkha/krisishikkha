/**
 * APP.JS
 * Smart Multi-Page Rendering with Block-based Pagination
 */
...
class QuestionSolutionApp {
    constructor() {
        ...
        this.PAGE_MARGIN_TOP_MM = 10;      // was 20mm
        this.PAGE_MARGIN_BOTTOM_MM = 10;   // was 20mm
        this.PAGE_MARGIN_LEFT_MM = 10;     // was 20mm
        this.PAGE_MARGIN_RIGHT_MM = 10;    // was 20mm
        this.FOOTER_SPACE_MM = 8;          // space reserved for footer
        
        // Usable Height Calculation
        this.USABLE_HEIGHT_MM = this.A4_HEIGHT_MM - 
                                 this.PAGE_MARGIN_TOP_MM - 
                                 this.PAGE_MARGIN_BOTTOM_MM - 
                                 this.FOOTER_SPACE_MM; // 269mm
        ...
        console.log(`📐 Usable Height: ${this.USABLE_HEIGHT_MM}mm (${this.USABLE_HEIGHT_MM * this.MM_TO_PX}px)`);
    }
    ...
    toggleDebugMode() {
        ...
        this.showNotification(`🐛 Debug Mode: ${mode}`, 'info');
    }
    ...
    debouncedUpdate() {
      ...
      updatePreview() {
        ...
        // Create pages with smart pagination
    ...
    createSmartPages(titles, contentHTML, watermark, footer) {
        ...
        let currentY = 0; // Track current Y position in mm
        ...
        if (titles.length > 0) {
            ...
            if (this.debugMode) {
                console.log(`📏 Title height: ${titleHeight.toFixed(2)}mm`);
            }
        }
        ...
        for (let i = 0; i < contentBlocks.length; i++) {
            ...
            if (this.debugMode) {
                console.log(`📦 Block ${i + 1} height: ${blockHeight.toFixed(2)}mm, Current Y: ${currentY.toFixed(2)}mm`);
            }
            
            // Check if block fits in remaining space
            if (currentY + blockHeight > this.USABLE_HEIGHT_MM) {
                if (this.debugMode) {
                    console.log(`⚠️ Block ${i + 1} doesn't fit. Creating new page...`);
                }
            ...
            if (this.debugMode) {
                console.log(`✅ Block ${i + 1} added. New Y: ${currentY.toFixed(2)}mm`);
            }
        }
        
        console.log(`📄 Created ${this.previewContainer.querySelectorAll('.a4-page').length} page(s)`);
    }
    ...
    parseContentBlocks(contentHTML) {
        ...
        for (let child of children) {
            ...
            // Group related elements into blocks
