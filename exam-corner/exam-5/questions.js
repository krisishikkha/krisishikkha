...
},
{
  ...
  answer: 0,
  explanation: "ফসলের ধরন এবং জাত নির্বাচন করার ক্ষেত্রে মূলত জলবায়ু গুরুত্বপূর্ণ ভূমিকা পালন করে। আবহাওয়া, বৃষ্টিপাত ও তাপমাত্রার সঙ্গে ফসলের বৃদ্ধি সম্পর্কিত। (Source: FAO – Food and Agriculture Organization)"
},
{
...
},
{
  ...
  answer: 0,
  explanation: "দিনে প্রাপ্ত সূর্যালোকের সময়কালকে দিবা দৈর্ঘ্য বলা হয়। এটি উদ্ভিদের ফোটোপিরিয়ড এবং বৃদ্ধিতে প্রভাব ফেলে। (Source: Encyclopedia of Plant Physiology)"
},
{
...
},
{
  ...
  answer: 3,
  explanation: "বায়ুমণ্ডলের প্রায় ৭৮% নাইট্রোজেন নিয়ে গঠিত, যা উদ্ভিদ ও প্রাণীর জন্য সরাসরি ব্যবহারযোগ্য নয়। (Source: NASA Earth Science)"
},
{
...
},
{
  ...
  answer: 0,
  explanation: "গভীর পানিতে স্থানীয় আমন জাত জন্মায়। বোরো ধান সাধারণত শীতকালে কম পানিতে জন্মে। (Source: BRRI – Bangladesh Rice Research Institute)"
},
{
...
},
{
  ...
  answer: 3,
  explanation: "শিশির ও কুয়াশা বেশি হলে আলুর মধ্যে ফাঙ্গাল প্যাথোজেন সক্রিয় হয়ে 'ধ্বসা রোগ' (Late Blight) দেখা দেয়। এটি আলুর প্রধান রোগ। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
...
},
{
  ...
  options: [
    ...
    "শীতপ
  answer: 0,
  explanation: "ব্রয়লার মুরগি সাধারণত খরাপ্রবণ এলাকায় পালন করা হয়, কারণ সেখানে অন্যান্য দুর্যোগের ঝুঁকি তুলনামূলক কম। (Source: DLS – Department of Livestock Services, Bangladesh)"
},
{
...
},
{
  ...
  answer: 1,
  explanation: "পানিশূন্য পরিবেশে উদ্ভিদের কোষ অভিযোজন হিসেবে অভ্যন্তরীণ অভিস্রবণ চাপ (Osmotic Pressure) বৃদ্ধি পায়, যাতে পানি সংরক্ষণ হয়। (Source: Plant Physiology Textbook)"
},
{
...
},
{
  ...
  answer: 0,
  explanation: "বহুবর্ষী উদ্ভিদ মাটির নিচে রাইজোম, কন্দ বা বাল্ব গঠন করে সুপ্তাবস্থায় বেঁচে থাকে, যা পরবর্তী মৌসুমে নতুন গাছ গজায়। (Source: Plant Biology Textbook)"
},
{
  ...
  answer: 2,
  explanation: "পাতার রন্দ্র (stomata) খোলা ও বন্ধ হওয়া প্রস্বেদনের (transpiration) নিয়ন্ত্রণে গুরুত্বপূর্ণ। (Source: Plant Physiology Handbook)"
},
{
  ...
  answer: 1,
  explanation: "সরিষার পাতার রন্দ্র তাপমাত্রা বাড়লে কমে যায়, ফলে প্রস্বেদন কমে এবং পানি সংরক্ষণ হয়। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 0,
  explanation: "গো-মটরের পাতার আকার হ্রাস করে প্রস্বেদন নিয়ন্ত্রণ করে, যা খরার পরিবেশে সহায়ক। (Source: FAO – Drought Resistant Crops Report)"
},
{
  ...
  answer: 0,
  explanation: "তুলা, চিনাবাদাম, জোয়ার ও গো-মটর প্রজাতি গাছের পুরাতন পাতা ঝরিয়ে প্রস্বেদন কমায় এবং খরার পরিস্থিতিতে পানি সংরক্ষণ করে। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 1,
  explanation: "খেজুর, কুল, অড়হর, তরমুজ ও বারি গম-২৬ ইত্যাদি ফসল খরাসহিষ্ণু। (Source: FAO – Drought Resistant Crops Report)"
},
{
  ...
  answer: 2,
  explanation: "খরাসহিষ্ণু ফসলের বৈশিষ্ট্য হলো গভীরমূলী, ছোট বা পুরু পাতা, এবং শক্তিশালী শাখা। গুচ্ছমূল বৈশিষ্ট্য বহির্ভূত। (Source: Plant Adaptation Studies)"
},
{
  ...
  answer: 1,
  explanation: "খরা সহিষ্ণু গমের মধ্যে সোনালি জাত ভালো ফলন দেয় খরা পরিস্থিতিতে। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 2,
  explanation: "খরা সহিষ্ণু বেগুনের মধ্যে বারি বেগুন-৮ সবচেয়ে ভালো ফলন দেয় খরা অবস্থায়। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 3,
  explanation: "উত্তম লবণাক্ততা সহিষ্ণু ফসলের মধ্যে বার্লি অন্যতম, যা লবণাক্ত এলাকায় ভালো ফলন দেয়। (Source: FAO – Salt Tolerant Crops Report)"
  },
  {
  ...
  answer: 1,
  explanation: "মধ্যম লবণাক্ততা সহিষ্ণু ফসল হলো এমন ফসল যা অতিরিক্ত লবণযুক্ত মাটিতে কিছুটা টলারেন্স দেখায়। পালংশাক এই শ্রেণীর মধ্যে পড়ে। (Source: FAO – Salt Tolerant Crops Report)"
},
{
  ...
  answer: 2,
  explanation: "লবণাক্ততা সংবেদনশীল ফসল অতিরিক্ত লবণযুক্ত মাটিতে ক্ষতিগ্রস্ত হয়। স্ট্রবেরি এই শ্রেণীর মধ্যে পড়ে। (Source: FAO – Salt Sensitive Crops Report)"
},
{
  ...
  answer: 3,
  explanation: "মিষ্টি আলু খরা সহিষ্ণু ফসল। এটি কম আর্দ্রতা এবং সীমিত পানির মধ্যে টেকসই বৃদ্ধি পায়। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 0,
  explanation: "উপকূলীয় লবণাক্ত এলাকায় প্রধান ফসল ধান। ধানের অনেক জাত লবণাক্ত মাটিতে টলারেন্ট। (Source: BRRI – Bangladesh Rice Research Institute)"
},
{
  ...
  answer: 0,
  explanation: "সর্বনিম্ন বৃষ্টিপাত হয় লালপুরে। এটি বাংলাদেশের একটি শুকনো এলাকা। (Source: BMD – Bangladesh Meteorological Department)"
},
{
  ...
  answer: 2,
  explanation: "শীতকালে বায়ু শীতল এবং আর্দ্রতা কম থাকে, ফলে জলীয় বাষ্পের পরিমাণও কম থাকে। (Source: BMD – Bangladesh Meteorological Department)"
},
{
  ...
  answer: 0,
  explanation: "শীতকালে বায়ুর গড় আর্দ্রতা ৩০-৪৫% হয়। (Source: BMD – Bangladesh Meteorological Department)"
},
{
  ...
  answer: 0,
  explanation: "গ্রীষ্মকালে বায়ুর গড় আর্দ্রতা ৬০-৭৫% থাকে। (Source: BMD – Bangladesh Meteorological Department)"
},
{
...
},
{
  ...
  answer: 2,
  explanation: "চরাঞ্চলের মাটি প্রায়শই বালুকাময় ও নদীর তাজা মাটি দ্বারা গঠিত। খেজুর গাছ এই ধরনের চরাঞ্চলে টেকসই এবং মাটির ক্ষয় রোধ করতে সহায়ক। (Source: BARI – Bangladesh Agricultural Research Institute)"
},
{
  ...
  answer: 2,
  explanation: "রাসায়নিক সার ও কীটনাশকের বিষাক্ততা প্রধানত অতিবৃষ্টির ফলে ধুয়ে যায় বা মাটিতে মিশে যায়। এখানে সঠিক উত্তর অপশনে ছিল না, তাই প্রশ্নটি ভুলভাবে রাখা হয়েছে। (Correct Answer: অতিবৃষ্টি) (Source: FAO – Environmental Impact of Fertilizers)"
},
{
