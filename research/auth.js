const RESEARCH_SESSION_KEY = "research_logged_user";
...
function findUser(username, password) {
  return RESEARCH_USERS.find(user =>
...
function saveSession(user) {
  ...
  localStorage.setItem(RESEARCH_SESSION_KEY, JSON.stringify(sessionData));
}

function getSession() {
  const saved = localStorage.getItem(RESEARCH_SESSION_KEY);
